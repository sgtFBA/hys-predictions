...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  table.scores-table {{ width: auto; max-width: 100%; border-collapse: collapse; font-size: 0.82rem; }}
  ...
  table.scores-table th:last-child, table.scores-table td:last-child {{ padding-right: 4px; }}
